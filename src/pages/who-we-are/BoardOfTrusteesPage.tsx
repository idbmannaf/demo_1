        ...
        <div className="pt-20">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
                <motion.div
                    ...
                    className="mb-12"
                >
                    <h2 className="text-3xl font-bold text-gray-900 mb-6 text-center">Our Distinguished Board Members</h2>
                    <p className="text-lg text-gray-600 text-center max-w-4xl mx-auto">
                        Our Board of Trustees brings together exceptional leaders from diverse backgrounds,
                        providing strategic guidance and oversight to ensure RDRS Bangladesh continues to fulfill its mission effectively.
                    </p>
                </motion.div>
                        ...
                        >
                            ...
                            <div className={`lg:col-span-1 ${index % 2 === 0 ? '' : 'lg:col-start-3'}`}>
                                <div className="sticky top-24">
                                    <div className={`bg-gradient-to-br p-8 rounded-2xl border shadow-xl ${index % 2 === 0
                                        ...
                                        >
                                            ...
                                            {/* Decorative overlay */}
                                            <div className={`absolute inset-0 bg-gradient-to-t rounded-xl ${index % 2 === 0
                                        ...
                                        >
                                            ...
                                            <p className={`font-semibold ${index % 2 === 0 ? 'text-blue-600' : 'text-green-600'
                                                }`}>{member.position}</p>
                                            <div className={`mt-4 w-16 h-1 rounded-full mx-auto ${index % 2 === 0 ? 'bg-blue-500' : 'bg-green-500'
                                                }`}></div>
                                        </motion.div>
                                    </div>
                                </div>
                            ...
                            <div className={`lg:col-span-2 ${index % 2 === 0 ? '' : 'lg:col-start-1'}`}>
                                <div className="prose prose-lg max-w-none">
                                    ...
                                    >
                                        ...
                                        {member.achievements && (
                                            <div className={`bg-gradient-to-r p-6 rounded-xl border mb-6 ${index % 2 === 0
                                                ? 'from-blue-50 to-green-50 border-blue-100'
                                                : 'from-green-50 to-blue-50 border-green-100'
                                                }`}>
                                        ...
                                        <div className={`border-l-4 p-6 rounded-r-xl ${index % 2 === 0
...
export default BoardOfTrusteesPage; 